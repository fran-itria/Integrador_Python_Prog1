...
while tarea != 0:
    match tarea:
        case 1:
            tarea = autos(leer_archivo, escribir_archivo, listar_archivo, json, texto)
        case 2:
            tarea = clientes(leer_archivo, escribir_archivo, listar_archivo, json, texto)
        case 3:
            tarea = transacciones(leer_archivo, escribir_archivo, listar_archivo, json, texto)
